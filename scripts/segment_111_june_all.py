...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--local-threshold", type=float, default=0.02)
    parser.add_argument("--global-threshold", type=parse_float_or_none, default=None)
    parser.add_argument("--footprint-tolerance", type=float, default=0.45)
    parser.add_argument("--max-iterations", type=int, default=1_000_000)
    parser.add_argument("--min-grain-size", type=int, default=0)
    parser.add_argument("--stagnation-tolerance", type=int, default=100_000)
    ...
    parser.add_argument("--fill-remaining", action="store_true", default=True)
